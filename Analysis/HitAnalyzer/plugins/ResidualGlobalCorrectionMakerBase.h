...
//   virtual void analyze(const edm::Event &, const edm::EventSetup &) override;
  ...
  Matrix<double, 5, 5> curv2localJacobianSimpleD(const Matrix<double, 7, 1> &state, const MagneticField *field, const GloballyPositioned<double> &surface, double dEdx, double mass, double dBz = 0.) const;
