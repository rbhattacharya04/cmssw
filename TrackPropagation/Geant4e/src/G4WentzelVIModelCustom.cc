...
//         std::cout << "alternate lambdaeff: cross = " << cross << " lambdaeff = " << lambdaeff << std::endl;
...
//   std::cout << "tPathLength = " << tPathLength << " zPathLength =  " << zPathLength << std::endl;
...
//   std::cout << "singleScatteringMode = " << singleScatteringMode << " useSecondMoment = " << useSecondMoment << " nMscSteps = " << nMscSteps << std::endl;
...
//     std::cout << "singleScat = " << singleScat << std::endl;
...
//       std::cout << "lambdaeff = " << lambdaeff << " tPathLength = " << tPathLength << " z0 = " << z0 << " z = " << z << std::endl;
